...
<div class="Control_Trip_Stages_Position_outer_wrapper">
<div className="Control_Trip_Stages_Position_left Control_Trip_Stages_Position_inner_wrapper">
<i className="show fas fa-circle Control_Trip_Stages_Stage_Icon"><l className="Control_Trip_Stages_Stage_Icon_Number">2</l></i>
                       
<span className="Control_Trip_Stages_Stage_PlaceName">Cayo Santa Maria</span>
</div>

<div className="Control_Trip_Stages_Position_right Control_Trip_Stages_Position_inner_wrapper">
<span className="Control_Trip_Stages_Stage_HotelName">Memories Jibacoa</span>
</div>
</div>
<div class="Control_Trip_Stages_Position_outer_wrapper">
<div className="Control_Trip_Dates_Position_left Control_Trip_Stages_Position_inner_wrapper">
<i className="hide far fa-car Control_Trip_Stages_Stage_Transport_Icon"></i>
<i className="show far fa-bus Control_Trip_Stages_Stage_Transport_Icon"></i>
</div>

<div className="Control_Trip_Stages_Position_right Control_Trip_Stages_Position_inner_wrapper">
<span className="Control_Trip_Stages_Stage_HotelFeatures">COAST - LARGE HOTEL - HERITAGE - £</span>
<i className="show fas fa-moon Control_Trip_Stages_Stage_Nights_Icon">7</i>
</div>
</div>
</a><div>
</div>
