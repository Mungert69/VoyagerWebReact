...
export class Control_Menu_3 extends Component {
  render() {
    return (
      <div>
          ...
          <div className="flex-container">
            <div className="Show">
              <a
                ...
                onClick={() => this.props.changeView("country")}
              >
                <i className="fas fa-globe-americas Voyager_Control_Icon_Size_2" />
                <span className="Voyager_Control_Text_Size_1_Link">
                  country
                </span>
              </a>
            </div>
            ...
            <div className="Show">
              <a
                className="Voyager_Control_Item_A"
                onClick={() => this.props.changeView("trip")}
              >
                <i className="fas fa-map-marked Voyager_Control_Icon_Size_2" />
            ...
            <div className="Show">
              <a
                className="Voyager_Control_Item_A"
                onClick={() => this.props.changeView("place")}
              >
            ...
            <div className="Show">
              <a
                className="Voyager_Control_Item_A"
                onClick={() => this.props.changeView("hotel")}
              >
            ...
            <div className="Show">
              <a
                className="Voyager_Control_Item_A"
                onClick={() => this.props.changeView("profiles")}
              >
                <l />
                <i className="fas fa-users Voyager_Control_Icon_Size_2" />
                <span className="Voyager_Control_Text_Size_1_Link">
                  profiles
                </span>
              </a>
