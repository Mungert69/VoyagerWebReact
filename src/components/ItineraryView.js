...
<a className="Control_Trip_Stages_Stage_PlaceName" onClick={() => this.props.setBuilderCardEvent(null, index, 'place')}>{prSelection.place}</a>
</div>

<div className="Control_Trip_Stages_Position_right Control_Trip_Stages_Position_inner_wrapper">
<a className="Control_Trip_Stages_Stage_HotelName" onClick={() => this.props.setBuilderCardEvent(null, index, 'hotel')}>{prSelection.hotel}</a>
</div>
</div>
<div class="Control_Trip_Stages_Position_outer_wrapper">
...
<i className="show fas fa-moon Control_Trip_Stages_Stage_Nights_Icon"></i>         
